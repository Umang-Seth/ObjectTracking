...
cv2.createTrackbar("HUE Min","HSV",80,179,empty)
cv2.createTrackbar("HUE Max","HSV",105,179,empty)
cv2.createTrackbar("SAT Min","HSV",75,255,empty)
cv2.createTrackbar("SAT Max","HSV",255,255,empty)
cv2.createTrackbar("VALUE Min","HSV",80,255,empty)
cv2.createTrackbar("VALUE Max","HSV",255,255,empty)

cv2.namedWindow("Parameters")
cv2.resizeWindow("Parameters",640,240)
cv2.createTrackbar("Threshold1","Parameters",0,255,empty)
cv2.createTrackbar("Threshold2","Parameters",154,255,empty)
cv2.createTrackbar("Area","Parameters",311,30000,empty)
